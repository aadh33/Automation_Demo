...
# ------------- CONFIGURATION -----------------
PORT = "COM22"   # TODO: Set this to your Arduino serial port!
LED_PIN = 13
...
# -- Logging: Simultaneous TXT/HTML logs --
...
# ---- User-input seconds with per-second validation and logging ----
    ...
    def action():
        try:
            ...
            messagebox.showerror(
                "Invalid", "Please enter a valid number of seconds (0.1 to 3600).")
            return
...
# ----------- Real-time log window popup -----------------
def show_log_window():
    log_win = tk.Toplevel(root)
    log_win.title("Real-Time Log")
    log_win.geometry("700x300")
    text_box = scrolledtext.ScrolledText(log_win, font=("Consolas", 10), wrap=tk.WORD)
    ...
    def update_logs():
        ...
        if log_win.winfo_exists():
            log_win.after(1000, update_logs)  # update every 1 second
...
tk.Button(root, text="Show Logs", width=25, command=show_log_window, bg="#ccf").pack(pady=7)
